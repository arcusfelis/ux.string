...
-define(UCDATA, "data/UnicodeData.txt"). % http://www.ksu.ru/eng/departments/ktk/test/perl/lib/unicode/UCDFF301.html
...
-define(UC_CC_OUT, "string/char_comment.hrl").
-define(UC_CL_OUT, "string/ccc.hrl").
